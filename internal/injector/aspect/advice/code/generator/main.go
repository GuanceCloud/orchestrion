...
func main() {
	...
	file.HeaderComment("")
	file.HeaderComment(fmt.Sprintf("Code generated by %q; DO NOT EDIT.", "github.com/GuanceCloud/orchestrion/internal/advice/code/generator "+strings.Join(os.Args[1:], " ")))
